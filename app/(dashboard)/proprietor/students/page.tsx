...
const sidebarLinks = [
  { name: "Dashboard", icon: LayoutDashboard, href: "/proprietor" },
  { name: "Students", icon: Users, active: true, href: "/proprietor/students" },
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-4 text-[12px] font-medium">
                    <div className="flex items-center gap-1.5 text-gray-500">
                      ...
                      <span className="text-[#1a2332] font-bold">5</span> boys
                      (50%)
                    </div>
                    <div className="flex items-center gap-1.5 text-gray-500">
                      <div className="w-2 h-2 rounded-full bg-gray-400"></div>
                      <span className="text-[#1a2332] font-bold">5</span> girls
                      (50%)
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex items-center gap-4 text-[12px] font-medium">
                    <div className="flex items-center gap-1.5 text-gray-500">
                      <div className="w-2 h-2 rounded-full bg-[#1a2332]"></div>
                      <span className="text-[#1a2332] font-bold">1</span> boys
                      (100%)
                    </div>
                    <div className="flex items-center gap-1.5 text-gray-500">
                      <div className="w-2 h-2 rounded-full bg-gray-400"></div>
                      <span className="text-[#1a2332] font-bold">0</span> girls
                      (0%)
                    </div>
                  </div>
                </div>
                    ...
                    {currentStudentsData.map((student) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-3.5 whitespace-nowrap text-gray-500">
                          {student.admissionNo}
                          <div className="text-[#1a2332] mt-0.5 font-medium">
                            {student.className}
                          </div>
                        </td>
                        <td className="px-6 py-3.5 whitespace-nowrap text-gray-500">
