...
export default function CreateCbtModal({
  isOpen,
  onClose,
}: CreateCbtModalProps) {
        ...
        options:
          type === "MCQ"
            ...
            : type === "TRUE_FALSE"
              ...
              : [],
        correctAnswer:
          type === "MCQ" ? "0" : type === "TRUE_FALSE" ? "True" : "",
        points: 1,
      },
    ]);
  }
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-5">
          ...
          >
            ...
            <div className="space-y-4">
              <h3 className="text-[13px] font-bold text-[#1a2332]">
                Exam Details
              </h3>

              <div>
                <label className="block text-[12px] font-semibold text-[#1a2332] mb-1.5">
                  Title
                </label>
                <input
                  required
                  ...
                  placeholder="e.g. Mid-Term Math Assessment"
                  className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-[12px] text-[#1a2332] focus:outline-none focus:ring-1 focus:ring-[#1a2332]"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-[12px] text-[#1a2332] bg-white focus:outline-none focus:ring-1 focus:ring-[#1a2332]"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3.5 py-2.5 text-[12px] text-[#1a2332] resize-none focus:outline-none focus:ring-1 focus:ring-[#1a2332]"
                />
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-blue-50 text-blue-700 text-[11px] font-semibold px-3 py-1.5 rounded-lg hover:bg-blue-100 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-purple-50 text-purple-700 text-[11px] font-semibold px-3 py-1.5 rounded-lg hover:bg-purple-100 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-emerald-50 text-emerald-700 text-[11px] font-semibold px-3 py-1.5 rounded-lg hover:bg-emerald-100 transition-colors"
                  >
                    ...
                    >
                      <div className="flex items-start justify-between mb-3 gap-4">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-bold bg-[#1a2332] text-white px-2 py-0.5 rounded">
                            Q{qIndex + 1}
                          </span>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-end gap-2 mt-4 pt-4 border-t border-gray-200">
                          ...
                          <input
                            ...
                            className="w-16 border border-gray-200 rounded-lg px-2 py-1 text-[11px] text-[#1a2332] text-center focus:outline-none focus:ring-1 focus:ring-[#1a2332]"
                          />
                        </div>
                      </div>
                    </div>
